...
./configure --prefix=$PREFIX 2>&1 --with-apxs2=/usr/local/httpd/httpd-2.4.23/bin/apxs --with-gd --with-png-dir=/usr/local/libpng/libpng-1.6.24 --with-zlib-dir=/usr/local/zlib/zlib-1.2.8 --with-pdo-pgsql=/usr/local/postgresql/postgresql-9.5.4 --with-pgsql=/usr/local/postgresql/postgresql-9.5.4 --with-libxml-dir=/usr/local/libxml2/libxml2-2.9.4 --with-pdo-mysql --enable-mbstring --enable-zip --with-curl=/usr/local/curl/curl-7.50.1 | tee $DIRPATH/configure.txt | grep -i error
