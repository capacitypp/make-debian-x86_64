...
./configure --prefix=$PREFIX 2>&1 --with-apxs2=/usr/local/httpd/httpd-2.0.61/bin/apxs --with-gd --with-png-dir=/usr/local/libpng/libpng-1.6.24 --with-zlib-dir=/usr/local/zlib/zlib-1.2.8 --with-pgsql=/usr/local/postgresql/postgresql-8.1.0 --with-libxml-dir=/usr/local/libxml2/libxml2-2.6.20 | tee $DIRPATH/configure.txt | grep -i error
